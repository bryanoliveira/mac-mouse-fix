...
#define kMFBundleIDApp      @"com.bryanoliveira.mac-mouse-fix"
#define kMFBundleIDHelper   @"com.bryanoliveira.mac-mouse-fix.helper"
...
#define kMFLaunchdHelperIdentifierSM  @"com.bryanoliveira.mac-mouse-fix.helper"
